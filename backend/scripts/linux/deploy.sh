...
#   4. Restarts the service (always -- gunicorn has no auto-reload)
#
# Requirements:
#   - setup.sh must have been run at least once
#
# NOTE: the systemd service file is NOT synced here. It contains absolute VPS
# paths generated by setup.sh and must not be overwritten by a code deploy.
# To update the service file, re-run: ./scripts/linux/setup.sh
# =============================================================================
